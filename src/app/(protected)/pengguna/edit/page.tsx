...
const MAX_SIZE_UPLOAD = 2 * 1024 * 1024; // 2MB
                        ...
                        {isLoading ? (
                          ...
                          <>
                            ...
                            <Label
                              ...
                              className="bg-primary text-white p-2 rounded-full cursor-pointer hover:bg-primary-dark transition-colors -mt-8 mr-[-60px] z-10"
                            >
