...
interface ShippingCardEstimationProps {
    ...
    handleValidShipping?: (val: boolean) => void
}


export const service_name = "jne"

export const service_type = "REG23";

export default function ShippingCardEstimation({ items, storeVillageId, handleValidShipping = () => { } }: ShippingCardEstimationProps) {
        ...
        <div className="border-t border-gray-200 pt-4 mt-4">
            <div className="flex justify-between items-center mb-2">
                ...
                {!destination_village_id ? (
                    <p className="text-red-500 mt-2">Silahkan tentukan alamat pengiriman anda!</p>
