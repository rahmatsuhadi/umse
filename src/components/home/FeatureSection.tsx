  ...
  return (
    <section className="pb-12 md:pb-20 ">
      <div className="container mx-auto px-4">
        <motion.div
          className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 md:gap-3"
        ...
        >
          {features.map((feature, index) => (
            <Link href={feature.link} key={index}>
              <motion.div
                key={index}
                className="flex flex-col items-center p-2 sm:p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition duration-300 group"
