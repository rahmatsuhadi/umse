...
function SubdistrictCard({
    ...
    return (
        ...
        >
            <div className="subdistrict-icon" style={{ position: "relative", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center", padding: logo ? 0 : undefined }}>
                {logo && (
...
const SubdistrictSkeleton = () => (
    <div className="subdistrict-card" style={{ opacity: 0.7, pointerEvents: "none" }}>
        <div className="subdistrict-icon" style={{ animation: "pulse 1.5s infinite" }}></div>
