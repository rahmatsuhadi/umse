...
export default function ProductStickyWA({ productId, productName, quantity, phone }: ProductStickyWAProps) {
    ...
    return (
        <button
            ...
            style={{ textDecoration: "none", flexShrink: 0, cursor: "pointer", border: "none" }}
        >
